    ...
    <div id="carouselExampleControls" class="carousel slide fade-in" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="/images/index/poto11.png" alt="Gambar1" />
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="/images/index/poto22.png" alt="Gambar2" />
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="/images/index/poto33.png" alt="Gambar3" />
            </div>
        </div>
